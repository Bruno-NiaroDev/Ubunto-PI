...
if(isset($_POST["btnDoadores"])){
    ...
    $sqlInserir = "INSERT INTO doadores(nomeDoador, cep, uf, cidade, bairro, logradouro, numero, telefone, celular, complemento) 
    VALUES('".$nomeDoador."', '".$cep."', '".$uf."', '".$cidade."', '".$bairro."', '".$logradouro."', '".$numero."', '".$telefone."', '".$celular."', '".$complemento."')";
